...
If you have a GT130 also connected to Neviweb make sure to put the names of your two GT125 network or it is possible that during setup, the GT130 network will be picked up accidentally. If you have only two GT125 network, you can omit there names as during setup, the first two network found will be picked up automatically.
